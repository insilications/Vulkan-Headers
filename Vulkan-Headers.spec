...
Version  : 1.1.112
Release  : 15
URL      : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.1.112/Vulkan-Headers-1.1.112.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.1.112/Vulkan-Headers-1.1.112.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.1.112
...
export LANG=C
export SOURCE_DATE_EPOCH=1561364173
mkdir -p clr-build
pushd clr-build
