...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.1.125/Vulkan-Headers-1.1.125.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.1.125
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1571067585
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/Vulkan-Headers-1.1.125/LICENSE.txt %{buildroot}/usr/share/package-licenses/Vulkan-Headers/2b8b815229aa8a61e483fb4ba0588b8b6c491890
pushd clr-build
%make_install
popd
