...
Version  : 1.1.106
Release  : 11
URL      : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.1.106/Vulkan-Headers-1.1.106.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.1.106/Vulkan-Headers-1.1.106.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.1.106
...
export LANG=C
export SOURCE_DATE_EPOCH=1554784069
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
