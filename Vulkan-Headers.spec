...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.1.107/Vulkan-Headers-1.1.107.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.1.107
...
export LANG=C
export SOURCE_DATE_EPOCH=1556296502
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
