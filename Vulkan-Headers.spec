...
Version  : 1.1.123
Release  : 24
URL      : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.1.123/Vulkan-Headers-1.1.123.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.1.123/Vulkan-Headers-1.1.123.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.1.123
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568914574
mkdir -p clr-build
pushd clr-build
