...
Version  : 1.1.117
Release  : 19
URL      : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.1.117/Vulkan-Headers-1.1.117.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.1.117/Vulkan-Headers-1.1.117.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.1.117
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1564419896
mkdir -p clr-build
pushd clr-build
