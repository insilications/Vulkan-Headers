...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.1.114/Vulkan-Headers-1.1.114.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.1.114
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1562651715
mkdir -p clr-build
pushd clr-build
