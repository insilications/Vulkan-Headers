...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.1.124/Vulkan-Headers-1.1.124.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.1.124
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570434637
mkdir -p clr-build
pushd clr-build
