...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.1.111/Vulkan-Headers-1.1.111.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.1.111
...
export LANG=C
export SOURCE_DATE_EPOCH=1560266742
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
