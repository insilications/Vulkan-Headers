...
Version  : 1.1.120
Release  : 21
URL      : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.1.120/Vulkan-Headers-1.1.120.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.1.120/Vulkan-Headers-1.1.120.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.1.120
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1566177900
mkdir -p clr-build
pushd clr-build
