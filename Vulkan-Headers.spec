...
Version  : 1.1.121
Release  : 22
URL      : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.1.121/Vulkan-Headers-1.1.121.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.1.121/Vulkan-Headers-1.1.121.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.1.121
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1566910028
mkdir -p clr-build
pushd clr-build
