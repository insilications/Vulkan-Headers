...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.1.122/Vulkan-Headers-1.1.122.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.1.122
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568049875
mkdir -p clr-build
pushd clr-build
