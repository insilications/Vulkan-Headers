...
%prep
%setup -q -n Vulkan-Headers-1.2.137
cd %{_builddir}/Vulkan-Headers-1.2.137
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586278712
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/Vulkan-Headers-1.2.137/LICENSE.txt %{buildroot}/usr/share/package-licenses/Vulkan-Headers/2b8b815229aa8a61e483fb4ba0588b8b6c491890
pushd clr-build
%make_install
popd
