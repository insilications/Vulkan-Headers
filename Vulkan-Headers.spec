...
Version  : 1.1.105
Release  : 10
URL      : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.1.105/Vulkan-Headers-1.1.105.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.1.105/Vulkan-Headers-1.1.105.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.1.105
...
export LANG=C
export SOURCE_DATE_EPOCH=1553878662
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
