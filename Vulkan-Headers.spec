...
Version  : 1.1.115
Release  : 18
URL      : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.1.115/Vulkan-Headers-1.1.115.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.1.115/Vulkan-Headers-1.1.115.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.1.115
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1563113789
mkdir -p clr-build
pushd clr-build
