...
Version  : 1.2.136
Release  : 38
URL      : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.2.136/Vulkan-Headers-1.2.136.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.2.136/Vulkan-Headers-1.2.136.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.2.136
cd %{_builddir}/Vulkan-Headers-1.2.136
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585069324
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/Vulkan-Headers-1.2.136/LICENSE.txt %{buildroot}/usr/share/package-licenses/Vulkan-Headers/2b8b815229aa8a61e483fb4ba0588b8b6c491890
pushd clr-build
%make_install
popd
