...
Version  : 1.1.119
Release  : 20
URL      : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.1.119/Vulkan-Headers-1.1.119.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.1.119/Vulkan-Headers-1.1.119.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.1.119
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1565610925
mkdir -p clr-build
pushd clr-build
