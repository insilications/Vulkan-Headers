...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.1.113/Vulkan-Headers-1.1.113.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.1.113
...
export LANG=C
export SOURCE_DATE_EPOCH=1562036333
mkdir -p clr-build
pushd clr-build
