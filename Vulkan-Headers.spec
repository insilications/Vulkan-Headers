...
Version  : 1.1.96
Release  : 2
URL      : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.1.96.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.1.96.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.1.96
...
export LANG=C
export SOURCE_DATE_EPOCH=1545237056
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
